...
def add_item():
    try:
        ...
        # cursor.execute('INSERT INTO reviews (name, date, place, rating, company, review, time) VALUES (%s, %s, %s, %s, %s, %s, %s);', (name, formatted_date, place, rating, company, review, formatted_time))
        # conn.commit()
        conn.close()
